...
from utils_text_continual import get_loops, get_dataset_embedding, get_network_embedding, get_eval_pool, evaluate_synset, get_daparam, match_loss, get_time, TensorDataset, epoch, DiffAugment, ParamDiffAug
...
def main():
    ...
    for exp in range(args.num_exp):
        ...
        for it in range(args.Iteration+1):
            ...
            if it in eval_it_pool:
                for model_eval in model_eval_pool:
                    ...
                    for it_eval in range(args.num_eval):
                        net_eval = get_network_embedding(model_eval, embedding_size, num_classes).to(args.device) # get a random model
            ...
            net = get_network_embedding(args.model,  embedding_size, num_classes).to(args.device) # get a random model
            net.train()
